    ...
    const result = await query(
      `UPDATE vehiculo_gasolina_registros
       SET titulo = $1,
           ...
           primera_carga = $13,
           origen_carga = $14,
           inventario_pipa_registro_id = $15,
           pipa_nombre_snapshot = $16,
           precio_litro_referencia = $17,
           placa_snapshot = $18,
    ...
    const result = await query(
      `UPDATE vehiculo_gasolina_registros
       SET vehiculo_id = $1,
           ...
           primera_carga = $14,
           origen_carga = $15,
           inventario_pipa_registro_id = $16,
           pipa_nombre_snapshot = $17,
           precio_litro_referencia = $18,
           placa_snapshot = $19,
